defmodule Yic2.ApisTest do
  ...
  describe "apis" do
    ...
    test "create_api/1 with valid data creates a api" do
      valid_attrs = %{name: "some name", version: %{}, request: "some request", description: "some description", definition: %{}}
    ...
    test "update_api/2 with valid data updates the api" do
      api = api_fixture()
      update_attrs = %{name: "some updated name", version: %{}, request: "some updated request", description: "some updated description", definition: %{}}
