...
config :yic2, Yic2Web.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "jvvFrxEiKXpP2LoCcNz/I12JupIUHTpnCar4RZx9Ucs8RRS3qXo+xPvXG+v6LUPY",
  watchers: []
...
# Add Cors_plug to accept incoming from httpd
# config :cors_plug, origin: ["http://casaos:82"]