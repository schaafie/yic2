...
#
#     Yic2.Repo.insert!(%Yic2.SomeSchema{})
#
...
alias Yic2.Seed.SeedData
alias Yic2.Seed.SeedForm
alias Yic2.Seed.SeedApi
alias Yic2.Seed.SeedContent

updated = Repo.insert! %User{ email: "admin@example.com", firstname: "ad", lastname: "ministrator" }
Repo.insert! %Account{ login: "admin", hash_password: Bcrypt.hash_pwd_salt("admin123"), user_id: updated.id }
