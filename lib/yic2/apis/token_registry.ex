defmodule Yic2.Apis.TokenRegistry do
  use GenServer
  ...
  defp get_jwt_token login, password, url do
    ...
    body = Jason.encode!( %{ login: login, password: password } )
    # headers = [{"Content-type", "application/json"}]
    
    req = Req.new( url: url, method: :post, body: body, headers: [{"content-type", "application/json"}] )
