<<<<<<< HEAD
defmodule Yic2.Seed.SeedForm do
    ...
    def data_dff do 
        %{ title: "Form detail", type: "detail", saveaction: "/forms/forms/:id", globalValidations: [],
            ...
            elements: [
              ...
              %{datapath: "owner", label: "Owner", type: "select", source: "users", value: "id", display: ["firstname", "lastname"] },
    ...
    def data_ofu do 
        %{ title: "User overview", type: "overview", globalValidations: [],
            actions: [
                ...
                %{delete: %{label: "Delete", url: "users"}}
            ],
            elements: [
                %{datapath: "id", pk: true, type: "hidden"},
                %{datapath: "firstname", label: "First name", type: "text-only"},
                %{datapath: "infix", label: "Infix", type: "text-only"},
    ...
    # User detail form
    def data_dfu do 
        %{ title: "User detail", type: "detail", saveaction: "users/:id", globalValidations: [],
            actions: [ 
                %{create: %{url: "users"}}, 
                %{save: %{url: "users/:id"}}
            ],
            elements: [
              ...
              %{datapath: "infix", label: "Infix", type: "text"},
